...
const actorSchema = new mongoose.Schema({
  ...
  cnt_last5: { type: Number, default: 0 }, // Count of female directed movies in the last 5 years
  cnt_last10: { type: Number, default: 0 }, // Count of female directed movies in the last 10 years
  cnt_last20: { type: Number, default: 0 }, // Count of female directed movies in the last 20 years
  cnt_all: { type: Number, default: 0 }, // Count of female directed movies all time
  movies: [{ type: mongoose.Schema.Types.ObjectId, ref: 'Movie' }], // Array of movie IDs
  movies_total: Number, // Count of movies all time
